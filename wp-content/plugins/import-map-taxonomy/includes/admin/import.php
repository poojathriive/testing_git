<?php
	...
	else if(isset($_POST["btnGetConnectedTherapist"]))
	{
		$result = getConnectedTherapist();
	} else if(isset($_POST["btnGetUsersGeoLocation"])){
		$result = nks_getUsersGeoLocation();
	} else if(isset($_POST["btnGetContactedTherapist"])){
		$result = getContactedTherapist();
	}
	...
	<div class="row">
		...
		<div class="col-md-3 col-sm-12">
			<div class="row">
				...
				<div class="col-md-12 col-sm-6">
					<div class="form_block">
						<h5>Connect with Therapist</h5>
						<label>Click below button to get 'Connect with Therapist' data</label>
						<br>
						<form action="" method="POST">
							<input type="submit" class="btn btn-primary" name="btnGetConnectedTherapist" value="Get Data">
						</form>
					</div>
				</div>
				<div class="col-md-12 col-sm-6">
					<div class="form_block">
						<h5>Contacted Therapist Data</h5>
						<label>Click below button to get 'Contacted therapist' data</label>
						<br>
						<form action="" method="POST">
							<input type="submit" class="btn btn-primary" name="btnGetContactedTherapist" value="Get Data">
						</form>
					</div>
				</div>
				<div class="col-md-12 col-sm-6">
					<div class="form_block">
						<h5>Users GeoLocation</h5>
						<label>Click below button to get 'Users Location'</label>
						<br>
						<form action="" method="POST">
							<input type="submit" class="btn btn-primary" name="btnGetUsersGeoLocation" value="Get Data">
						</form>
					</div>
				</div>
			</div>
