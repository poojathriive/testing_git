...
<<<<<<< HEAD
	<?php if($_SERVER['SERVER_NAME'] != 'localhost' && $_SERVER['SERVER_NAME'] != 'thriive.noesis.tech' && $_SERVER['SERVER_NAME'] != 'thriive-staging.noesis.tech'){ ?>
...
<!--
			<div class="col-3 col-sm-2 icons-set">
				...
				?>
				<a href="<?php echo $page_link; ?>" class="right-icons"><i class="fa fa-user-circle-o" aria-hidden="true"></i></a>
				<?php }?>
			</div>
-->
		</div>
