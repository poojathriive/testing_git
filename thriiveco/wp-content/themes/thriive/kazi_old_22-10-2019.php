<?php /* Template Name: New Home Page bk2 */ ?>
<?php get_header(); ?>
        ...
        <div class="col-xs-6">
            <div class="menu_s">
                <a href="https://www.thriive.in/therapist" target="_blank">
                    <img style="width:100%" class="img-responsive" src="<?php echo get_template_directory_uri();?>/assets/images/THRIIVE_MOBILE-WEB-DESIGN-5_03.png" />
                </a>
            </div>
        </div>
        <div class="col-xs-6">
            <div class="menu_s">
                <a href="https://www.thriive.in/therapies" target="_blank">
                    <img style="width:100%" class="img-responsive" src="<?php echo get_template_directory_uri();?>/assets/images/THRIIVE_MOBILE-WEB-DESIGN-5_07.png" />
                </a>
            </div>
        </div>
        <div class="col-xs-6">
            <div class="menu_s">
                <a href="https://www.thriive.in/ailments-listing" target="_blank">
                    <img style="width:100%" class="img-responsive" src="<?php echo get_template_directory_uri();?>/assets/images/THRIIVE_MOBILE-WEB-DESIGN-5_13.png" />
                </a>
            </div>
        </div>
        <div class="col-xs-6">
            <div class="menu_s">
                <a href="https://www.thriive.in/blog" target="_blank">
                    <img style="width:100%" class="img-responsive" src="<?php echo get_template_directory_uri();?>/assets/images/THRIIVE_MOBILE-WEB-DESIGN-5_11.png" />
                </a>
            </div>
        </div>
...
// 			echo "<pre style='display:none;'>";print_r($flexible_content);echo"</pre>";
			if($flexible_content)
			{
                foreach($flexible_content as $section)
				{
					if($section['acf_fc_layout'] == 'blogs_widget')
					{
						...
						{?>
                        <section class="all_slider_issues container">
                            <h2 class="title-w3 text-bl font-weight-bold section_title"><?php  echo $section['blog_widget_title'];?></h2>
        ...
        <section class="all_slider_Therapists news_feed_contect">
            <h2 class="title-w3 text-bl font-weight-bold section_title mt-3">Media On Us</h2>
            <section class="blogs slider">
    ...
    <div class="carousel-inner">
        <div class="item carousel-item active">
            <div class="col-12">
				<h3 class="w-100 text-center mb-4 mt-2">Testimonials</h3>
            </div>
            <div class="testmonual_fetch slider">
                <?php while ( have_rows('testimonial') ) : the_row();?>
                    <div class="slide">
                    <div class="testimonial"><?php the_sub_field('description')?></div>
                    <div class="media">
<!--
